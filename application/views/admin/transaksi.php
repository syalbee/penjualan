...
<body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        ...
                                        <div class="form-inline">
                                            ...
                                            <option selected value="satu">List Barang</option>
                                        </select>
                                            <!-- <select class="form-control select2 form-control-lg  col-sm-9" onchange="getNama()"> -->
    ...
    <script>
        ...
        var produkGetharga = '<?php echo site_url('produk/get_harga') ?>';
        ...
        var cetakUrl = '<?php echo site_url('cetak/struk/') ?>';
    </script>
